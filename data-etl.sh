...
cat GBPCHF2.txt | sed 's/./&-/11;s/./&-/14;s/./&:/20;s/./&:/23' | awk -F, '{print $1","$2" "$3","$4","$5","$6","$7}' > GBPCHF.txt
pause 'Press [Enter] key to continue: change USDCHF'
cat USDCHF2.txt | sed 's/./&-/11;s/./&-/14;s/./&:/20;s/./&:/23' | awk -F, '{print $1","$2" "$3","$4","$5","$6","$7}' > USDCHF.txt
