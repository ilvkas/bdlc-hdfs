...
-- --------------------------------------------------
-- DDL src_* Tables
CREATE TABLE src_chfjpy_txt (Ticker STRING,Datum INT,Zeit INT,Open FLOAT,High FLOAT,Low FLOAT,Close FLOAT,Vol FLOAT)
COMMENT 'CHF-JPY Market'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY ','
STORED AS TEXTFILE;

CREATE TABLE src_eurchf_txt (Ticker STRING,Datum INT,Zeit INT,Open FLOAT,High FLOAT,Low FLOAT,Close FLOAT,Vol FLOAT)
COMMENT 'EUR-CHF Market'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY ','
STORED AS TEXTFILE;

CREATE TABLE src_gbpchf_txt (Ticker STRING,Datum INT,Zeit INT,Open FLOAT,High FLOAT,Low FLOAT,Close FLOAT,Vol FLOAT)
COMMENT 'GBP-CHF Market'
ROW FORMAT DELIMITED
FIELDS TERMINATED BY ','
STORED AS TEXTFILE;

CREATE TABLE src_usdchf_txt (Ticker STRING,Datum INT,Zeit INT,Open FLOAT,High FLOAT,Low FLOAT,Close FLOAT,Vol FLOAT)
